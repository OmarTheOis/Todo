...
class SwitchButtonOis extends StatefulWidget {
  final Function enabled;
  final Function disabled;
  const SwitchButtonOis({super.key,
  ...
  @override
  State<SwitchButtonOis> createState() => _SwitchButtonOisState();
}

class _SwitchButtonOisState extends State<SwitchButtonOis> {
